...
setInterval(() => {
  http.get(`http://proglitch.glitch.me/`);
}, 280000);
...
client.on("message", msg => {
  if (msg.content === "-inv") {
    msg.reply("**https://5f625442cadae.site123.me/**");
  }
});
...
client.on("guildCreate", guild => {
 var embed = new Discord.RichEmbed()
    .setColor(0x5500ff)
    .setDescription(`* http://5f625442cadae.site123.me لاتنسى دخول موقع البوت **`);
  guild.owner.send(embed);
});
...
client.login("NzU1ODI5NzQwMDY0OTk3Mzg4.X2I_TA.qawjkkvHegr9ZfiI8XAGXi521v0");
...
client.on("ready", () => {
  ...
  client.user.setGame(`كيفكن صبايا`, { type: "Playing" });
});